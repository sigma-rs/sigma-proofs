        ...
        pub mod $proof_module_name {
            ...
            mod lox_zkp_benches {
                ...
                fn prove(c: &mut Criterion) {
                    ...
                    // let mut group = c.benchmark_group("Prove zkp arguments");
                    c.bench_function("Prove Assignments", move |b| { b.iter(|| {
                ...
                fn verify_compact_proof(c: &mut Criterion) {
                    let mut rng = thread_rng();
                    struct RandomAssignments {
                        $(pub $secret_var: Scalar,)+
                        $(pub $instance_var: RistrettoPoint,)+
                    ...
                    // timing.
                    c.bench_function("Verify compact proof", move |b| { b.iter(|| {
                        let mut trans = Transcript::new(b"Benchmark");
                ...
                fn verify_batchable_proof(c: &mut Criterion) {
                    let mut rng = thread_rng();
                    struct RandomAssignments {
                        $(pub $secret_var: Scalar,)+
                        $(pub $instance_var: RistrettoPoint,)+
                    ...
                    c.bench_function("Verify batchable proof", move |b| { b.iter(|| {
                        let mut trans = Transcript::new(b"Benchmark");
