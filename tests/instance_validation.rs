...
mod instance_validation {
    ...
    fn test_inconsistent_equation_count() {
        ...
        relation.assign_element(var_g, G::generator());
        relation.assign_element(var_h, G::generator() * Scalar::from(2u64));
        relation.assign_element(var_img_1, G::generator() * Scalar::from(3u64));
    ...
    fn test_empty_string() {
        ...
        let narg_string = nizk.prove_batchable(&[].into(), rng).unwrap();
    ...
    fn test_statement_without_witness() {
        ...
        assert!(matches!(
            nizk.verify_batchable(&nizk.prove_batchable(&[].into(), rng).unwrap())
                .unwrap_err(),
